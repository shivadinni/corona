...
public class TestConfiguration {
	public static WebDriver getinstance()
	{
		...
		String browseType=com.corona.util.DataHandlers.getFromPropertyFile("cconfiguration","browser");
		String url=com.corona.util.DataHandlers.getFromPropertyFile("cconfiguration","url");
